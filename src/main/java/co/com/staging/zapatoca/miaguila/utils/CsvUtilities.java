...
public class CsvUtilities {
    ...
    public static List<Map<String, String>> getDataTest(String csvName, String filter) throws IOException {
        TestDataSource csvSourceData =
                new CSVTestDataSource(
                        getCsvPath(csvName), VALUE_SEPARATOR_CSV);
        return getFilteredData(csvSourceData, filter);
    }

    private static List<Map<String, String>> getFilteredData(TestDataSource csvData, String filterListString) {
